...
export const login = async (req, res) => {
  try {
    ...
    delete user.password; // delete the password so it's not sent to the front-end
    res.status(200).json({ token, user }); // send the token and the user object to the front-end
  } catch (err) {
