  ...
  return (
    <FlexBetween>
      <FlexBetween gap="1rem">
        ...
        <Box
          onClick={() => {
            navigate(`/profile/${friendId}`); // if you go to a friend of someone's, the components will not re-render
            navigate(0); // this is to refresh the page - in production we have to fix this
          }}
        >
          <Typography
            color={main}
